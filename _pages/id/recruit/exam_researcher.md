...
1. Share your Google Sheet with [{{ site.data.data.EMAIL }}](mailto:{{ site.data.data.EMAIL }}).
1. Send us an email at [{{ site.data.data.EMAIL }}](mailto:{{ site.data.data.EMAIL }}) notifying us of your completion.
